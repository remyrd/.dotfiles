...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(sketch-black
                         sketch-white
                         doom-nord
                         doom-nord-light
                         espresso)
